<x-layouts.app :title="$page->seoTitle()" :description="$page->seoDescription()" :canonical="$page->seoCanonicalUrl()" :og-image="$page->seoOgImageUrl()" :robots="$page->seoRobots()" :structured-data="$page->seoStructuredData()" :page-type="$page->seoPageType('AboutPage')" :schema-template="$page->seoSchemaTemplate()">
