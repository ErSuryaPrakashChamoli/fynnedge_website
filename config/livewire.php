...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        /*
         * Raised from Livewire's 12MB default so a video testimonial (up to
         * 20MB, see VideoTestimonialForm) can reach its own field's validation.
         * Every FileUpload still enforces its own, smaller maxSize. Keep this
         * below docker/php/php.ini's upload_max_filesize and nginx's
         * client_max_body_size (both 25M).
         */
